...
EXPECTED = {
    ...
    "storms_leggings": ("LEGENDARY", "armor", "leggings", 45000000, 18000000),
    "goldors_helmet": ("LEGENDARY", "armor", "helmet", 50000000, 20000000),
    "necrons_chestplate": ("LEGENDARY", "armor", "chestplate", 75000000, 30000000),
    "maxors_boots": ("LEGENDARY", "armor", "boots", 40000000, 16000000),
