...
_EFFECT_LORE = {
    ...
    "kill_small_coins": "击杀1个小怪获得80K Coin",
    "kill_boss_coins": "击杀1个关底BOSS获得10M Coin",
    "kill_midboss_coins": "击杀1个道中BOSS获得5M Coin",
...
SKYBLOCK_ITEMS = {
    ...
    "aspect_of_the_dragons": SkyblockItem(
        ...
        slot="weapon", buy_price="30M", sell_price="12M",
    ),
    ...
    "lapis_armor_helmet": SkyblockItem(
        ...
        slot="helmet", buy_price="350k", sell_price="120k",
    ),
    "lapis_armor_chestplate": SkyblockItem(
        "lapis_armor_chestplate", "Lapis Armor Chestplate", "UNCOMMON", "armor",
        effects={"kill_small_coins": 80000},
        lore=["击杀1个小怪时获得80K Coin", "4件全套：所有EPIC及以上物品+20%获取概率"],
        slot="chestplate", buy_price="1M", sell_price="300k",
    ),
    "lapis_armor_leggings": SkyblockItem(
        "lapis_armor_leggings", "Lapis Armor Leggings", "UNCOMMON", "armor",
        effects={"kill_boss_coins": 10000000, "kill_midboss_coins": 5000000},
        lore=["击杀1个关底BOSS时获得10M Coin；击杀1个道中BOSS时获得5M Coin", "4件全套：所有EPIC及以上物品+20%获取概率"],
        slot="leggings", buy_price="2M", sell_price="600k",
    ),
    "lapis_armor_boots": SkyblockItem(
        ...
        slot="boots", buy_price="300k", sell_price="100k",
    ),
    "heavy_armor_helmet": SkyblockItem(
        ...
        slot="helmet", buy_price="2M", sell_price="700k",
    ),
    "heavy_armor_chestplate": SkyblockItem(
        ...
        slot="chestplate", buy_price="4M", sell_price="1.5M",
    ),
    "heavy_armor_leggings": SkyblockItem(
        ...
        slot="leggings", buy_price="3M", sell_price="1.1M",
    ),
    ...
    "shadow_assassin_boots": SkyblockItem(
        ...
        slot="boots", buy_price="10M", sell_price="4M",
    ),
    ...
    "precursor_eye": SkyblockItem(
        ...
        slot="helmet", buy_price="35M", sell_price="14M",
    ),
    "superior_dragon_chestplate": SkyblockItem(
        ...
        slot="chestplate", buy_price="30M", sell_price="12M",
    ),
    ...
    "necrons_chestplate": SkyblockItem(
        ...
        slot="chestplate", buy_price="75M", sell_price="30M",
    ),
    ...
    "overflux_power_orb": SkyblockItem(
        ...
        lore=["C技能：Boss战中召唤Orb，若接下来10秒内持续处在Orb范围内获得1残机",
              "Orb判定大小约等于擦弹范围"],
        slot="accessory", buy_price="18M", sell_price="7M",
    ),
    "summoning_ring": SkyblockItem(
        ...
        slot="accessory", buy_price="25M", sell_price="10M",
    ),
    ...
    "enderman_pet_epic": SkyblockItem(
        ...
        effects={},
        lore=["C技能：向当前移动方向瞬移一段距离"],
        slot="accessory", buy_price="10M", sell_price="4M",
    ),
    "spider_artifact": SkyblockItem(
        ...
        slot="accessory", buy_price="6M", sell_price="2M",
    ),
    "catacombs_expert_ring": SkyblockItem(
        ...
        slot="accessory", buy_price="30M", sell_price="12M",
    ),
    ...
    "divans_alloy": SkyblockItem(
        ...
        buy_price="500M", sell_price="250M",
    ),
